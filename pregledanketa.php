	...
	<body>
		...
		<div id="Container22">
			...
			<div style="width:32%; height:170px; background-color:#efceff; float:left; text-align:center;">
					...
					<form name="mojaforma22" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<input type="submit" name="potvrdi" value="ZAPOCNI ANKETU" style="background-color:#34056d; color:white; cursor:pointer; position:relative; top:10px; left:32px;"> <br><br>
						...
						<?php
							...
							if(isset($_POST['imeankete'])){
								...
								if(mysqli_num_rows($rezultat3) == 1){
									...
									$upit4 = "SELECT * FROM anketapitanja WHERE ime_ankete = '".$_POST['imeankete']."'";

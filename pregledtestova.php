	...
	<body>
		...
		<div id="Container16">
			...
			<div style="width:32%; height:170px; background-color:#efceff; float:left; text-align:center;">
					...
					<form name="mojaforma16" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<?php
							...
							if(isset($_POST['imetesta'])){
								...
								if(mysqli_num_rows($rezultat3) == 1){
									...
									$upit4 = "SELECT * FROM testpitanja WHERE ime_testa = '".$_POST['imetesta']."'";
...
<form name="mojaforma40" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>"> 

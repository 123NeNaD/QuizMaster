	...
	<body>
		...
		<div id="Container27">
					...
					<div style="width:32%; height:170px; background-color:#efceff; float:left; text-align:center;">
						<form name="mojaforma28" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
							<br>
							<fieldset>
							...
							<?php
								...
								if(isset($_POST['imetesta'])){
									...
									if(mysqli_num_rows($rezultat1) == 0){
										echo "<label style='color:red;'><center><b>Ne postoji test koji zelite da obrisete.</b></center></label>";
									}
									...
									if(mysqli_num_rows($rezultat1) == 1){
										...
										if(mysqli_num_rows($rezultat3) == 1){
											...
											$upit4 = "DELETE FROM testpitanja WHERE ime_testa='".$_POST['imetesta']."'";
											$rezultat4 = mysqli_query($konekcija, $upit4) or die("Greska: " . mysqli_error($konekcija));
										
											$upit5 = "DELETE FROM testovi WHERE ime_testa='".$_POST['imetesta']."'";
											$rezultat5 = mysqli_query($konekcija, $upit5) or die("Greska: " . mysqli_error($konekcija));
											echo "<label style='color:green;'><center><b>Test uspesno obrisan.</b></center><label>"; 
										
										} else {
											echo "<label style='color:red;'><center><b>Izabrani test nije vas! Mozete brisati samo vase testove.</b></center></label>";
										}
									}
